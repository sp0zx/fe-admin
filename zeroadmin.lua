...
function CreateSave()
	writefile("zero admin.txt", defaultSettings)
	wait(0.5)
	local content = readfile("zero admin.txt")
...
function fullUpdate()
	...
	wait(0.2)
	writefile("zero admin.txt", fullUPDATED)
end
if writefile ~= nil then
	function builder()
		local TESTsave = readfile("zero admin.txt")
...
function createIntro(style, msg, length)
	...
	local info = "http://www.roblox.com/asset/?id=1281284684" -- 1281284684
	local warning = "http://www.roblox.com/asset/?id=1281286925" -- 1281286925
	if style == "info" then
		style = info
	...
	IMAGE2.Image = "http://www.roblox.com/asset/?id=176208188"
...
Commands.credits = function(args)
	Notification("info", "zero admin was made by sp0z#3799 , "..commandPrefix.."fullcredits for all credits.", 8)
end
...
Commands.fullcredits = function(args)
	Notification("info", "Credit to sp0z#1665, and squid (Help with "..commandPrefix.."remotespy and anti client kick)", 1)
	...
	Notification("info", "Only creator is sp0z", 2)
end
